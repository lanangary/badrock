...
class badrock_Timber
{
    ...
    {
        badrock_General::remove_filters_for_anonymous_class('timber/twig/filters', \Timber\Twig::class, 'add_timber_filters', 10);
    }
    ...
    public function add_to_twig($twig)
    {
        ...
        add_filter( 'timber/twig/default_filters', function( $filters ) {
            return array_merge($filters, [
                'resize' => [
                  'callable' => [badrock_ImageHelper::class, 'resize']
                ],
                'letterbox' => [
                  'callable' => [badrock_ImageHelper::class, 'letterbox'],
                ],
